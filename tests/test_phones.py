...
def test_phones_on_homepage(app):
    ...
    assert first_cont_from_homepage.homephone == clear(first_cont_from_edit_page.homephone)
    assert first_cont_from_homepage.mobilephone == clear(first_cont_from_edit_page.mobilephone)
    assert first_cont_from_homepage.workphone == clear(first_cont_from_edit_page.workphone)
    assert first_cont_from_homepage.secondaryphone == clear(first_cont_from_edit_page.secondaryphone)
